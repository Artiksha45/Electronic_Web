...
<section class="about">
   ...
   <div class="row">
      ...
      <!--<div class="content">
         ...
         <p> Welcome to Electronic_Gadgets, your one-stop destination for all things electronic! Founded in [2023], we are passionate about providing our customers with the latest gadgets, cutting-edge technology, and top-notch customer service.</p>
      ...
      <div class="content">
         <h3>About US</h3>
         <p> Welcome to  our Electronic_Gadgets, Our website is designed to help perticular shop.we are passionate about providing our customers with the latest gadgets, cutting-edge technology, and top-notch customer service.</p>
...
<section class="reviews">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <p>Electronic_Gadgets is great if you choose good sellers . A variety of required item available . Customers can return and refund full amount within 7 days easily . Electronic_Gadgets is boosting eCommerce business in Kathmandu.It provides great opportunity to sale items online with ease.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <div class="swiper-slide slide">
         ...
         <p>Using Electronic_Gadgets for online shopping from almost 3 years. Outstanding experience with them. Game vouchers and pick up point as delivery with 0 shipping charges are super saving services.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <div class="swiper-slide slide">
         ...
         <p>Electronic_Gadgets is cool! I have ordered hundreds of products from it and never got any scam. It delivers products in time with out delay. Packaging of products are strong and delivery rates are too low. Just amazing Website will keep shopping from Electronic_Gadgets.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
