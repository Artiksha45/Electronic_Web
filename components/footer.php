<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         <h3>Contact Us.</h3>
         <a href="tel:9800000000"><i class="fas fa-phone"></i> +919881008770</a>
         <a href="tel:9900000000"><i class="fas fa-phone"></i> +917974000000</a>
         <a href="mailto:harshchy143@gmail.com"><i class="fas fa-envelope"></i>electro@gmail.com</a>
         <a href="https://www.google.com/myplace"><i class="fas fa-map-marker-alt"></i> Baramati,Pune </a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Electronic_Gadgets</span> | all rights reserved!</div>
